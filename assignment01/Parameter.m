...
params_BIAS.kl = 150;	%    linear spring stiffness [N/m]
params_BIAS.y0l = 0.03;    %    linear spring pre-compression [m]
params_BIAS.m = 0.05;       %    mass [kg]
...
initConds.y                 = 0.014607193;                           % 	Initial displacement [m]
