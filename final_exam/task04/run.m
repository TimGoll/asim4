...
paw({time, time}, {theta_2, theta_ref}, {'theta_2', 'theta_{2,ref}'}, 'time [s]', 'theta', task_name, 'ziegler_nichols_theta2_controlled_with_d_tune2', plot_path, true, true, {'', ''}, 'southwest');
paw({time}, {u2}, {'u_2'}, 'time [s]', 'u [W]', task_name, 'ziegler_nichols_u2_controlled_with_d_tune2', plot_path, true, true, {''}, 'southwest');