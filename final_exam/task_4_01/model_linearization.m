...
det_m = m1 * m2 * (l1^2 * l2^2) / 16 ...
    + m2^2 * (l1^2 * l2^2) / 4 * (1 - cos(u2)^2) ...
    + I1 * m2 * l2^2 / 4 ...
    + I2 * m1 * l1^2 / 4 ...
    + I1 * I2 ...
    + m2 * I2 * l1^2 ...
...
M1 = m2 * l2^2 / 4 + I2;
M2 = -m2 * l2^2 / 4 + 1 / 2 * m2 * l1 * l2 * cos(u2);
M3 = -m2 * l2^2 / 4 + 1 / 2 * m2 * l1 * l2 * cos(u2);
M4 = m1 * l1^2 / 4 + I1 + m2 * l1^2 + m2 * l1^2 / 4 + m2 * l1 * l2 * cos(u2);

M_inv = 1 / det_m * [M1 M2; M3 M4];
